...
public interface ImagenMapper {
        ...
        List<Imagen> getImagenesPublicacion(@Param("publicacion_id") Integer publicacion_id)
         ...
         *                                       de datos.
         */
        @Results(id = "ImagenesMapUsuario", value = {
                        @Result(property = "id", column = "imagen_id"),
                        @Result(property = "imagen", column = "imagen") })
         ...
         *
         * @param imagen_id el id de la imagen a eliminar
         * @throws java.sql.PersistenceException Se dispara en caso de que se dispare un
         *                                       error en esta operación desde la base
         *                                       de datos.
         */
        @Delete("DELETE FROM imagen WHERE imagen_id = #{imagen_id};")
        void deleteImagen(@Param("imagen_id") Integer imagen_id) throws PersistenceException;

        /**
         * Busca un objeto de tipo '{@link mx.unam.backend.model.Imagen} '
         * contenido en la base de datos usando su id.
         *
         * @param imagen_id el id del comentario a buscar
        ...
        Imagen getByImagenId(@Param("imagen_id") Integer imagen_id) throws PersistenceException;
}